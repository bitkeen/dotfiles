" Powerline colorscheme for lightline with command mode configuration added.
...
let s:p.command.left = [ ['darkestpurple', 'white', 'bold'], ['white', 'mediumpurple'] ]
let s:p.command.right = [ ['darkestpurple', 'brightpurple'], ['brightpurple', 'mediumpurple'], ['brightpurple', 'darkestpurple'] ]
